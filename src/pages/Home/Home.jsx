...
export default function Home(){
    ...
    return (
        ...
        <div className='f-slide'> 
            <Navbar />
            <Slide heading={slides[0].heading}  parg={slides[0].parg} nb1={slides[0].nb1} nb2={slides[0].nb2} />
        </div>
        <div className="s-slide">
        <Slide heading={slides[1].heading}  parg={slides[1].parg} nb1={slides[1].nb1} nb2={slides[1].nb2} isLR={false}/>
        </div>
        <Menu/>
        </>
